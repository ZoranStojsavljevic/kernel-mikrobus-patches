...
### Kernel am33x-v5.13 status

	Status: Kernel am33x-v5.13 works with GPIO errors (UnStable - Yellow)
		MikroBUS driver does not work (RED)
### Issues (listing part of a dmesg log)
...
#### Real issue with GPIOs

Got to resolve issue with kernel 5.13.5-bone13 :
